 ...
 * @email       : owen@qq.com
 ***********************************************************/
package com.huawei.owen.admin.aspect;
...
import com.huawei.owen.common.utils.StringUtils;
...
public class MapperAspect {
    ...
    @Pointcut("execution(* com.huawei.owen.*.mapper.*.update*(..))")
    public void daoUpdate() {
    }

    @Pointcut("execution(* com.huawei.owen.*.mapper.*.insert*(..))")
